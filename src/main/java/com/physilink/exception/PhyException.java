...
import com.physilink.config.PropertiesConfig;
 ...
 */
@Component
public class PhyException {

    private static PropertiesConfig propertiesConfig;

    @Autowired
    public PhyException(PropertiesConfig propertiesConfig) {
        PhyException.propertiesConfig = propertiesConfig;
    }
