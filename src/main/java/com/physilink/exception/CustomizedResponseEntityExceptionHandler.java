...
import com.physilink.dto.response.Response;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(PhyException.EntityNotFoundException.class)
    ...
    @ExceptionHandler(PhyException.DuplicateEntityException.class)
